/**
 * ChatPanel
 * Right pane — chat interface with streaming support.
 */
"use client";
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <p className="max-w-xs text-sm text-slate-600">
        ...
        the first phase — deconstructing your concept into a Technical
        Specification.
      </p>
    </div>
  );
...
export function ChatPanel() {
  ...
  const { messages, isStreaming, streamingContent, activeSession } =
    useProjectStore();
    ...
    <div className="flex h-full flex-col bg-[#080c14]">
      ...
      <div className="flex items-center gap-2 border-b border-white/5 px-5 py-3">
        ...
        <span className="text-xs text-slate-500">
          {activeSession
            ? `Session · ${activeSession.current_phase}`
            : "Connecting…"}
        </span>
      </div>
          ...
          <textarea
            ...
            placeholder={
              isStreaming
                ...
                : "Describe your idea, ask a question, or respond to the agent…"
            }
            style={{ resize: "none" }}
